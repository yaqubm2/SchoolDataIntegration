...
/// dependency-free so the solution has no external package requirement just
/// to read a CSV file.
/// </summary>
public static class CsvParser
{
    /// <summary>Parses CSV text with a header row into rows of column-name -> value.</summary>
